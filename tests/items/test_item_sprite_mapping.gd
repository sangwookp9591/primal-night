...
func test_all_twenty_item_ids_map_to_the_documented_atlas_cells() -> void:
	assert_eq(WorldItem.ITEM_ATLAS_INDICES.size(), 20)
	...
	assert_eq((WorldItem.ITEM_SHEET as Texture2D).get_width(), 1280)
