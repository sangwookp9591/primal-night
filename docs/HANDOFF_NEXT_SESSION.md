...
| 3 | ~~장비 modifier 런타임 연결~~ 완료(`078ec55`): 뼈 갑옷 방어(물리 피해 곱연산)·가방 용량(+4슬롯/+8.0, 해제 초과 거부) | — | 신규 기획안: docs/design/PROPOSAL_INTERACTIONS_ITEMS_2026-07-19.md (플레이테스트 통과 후 착수 후보 16건) |
